  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-6">
      ...
      <form onSubmit={handleSubmit} className="glass-card p-8 space-y-8 relative overflow-hidden">
        {/* Decorative corner */}
        <div className="absolute -top-10 -right-10 w-20 h-20 bg-red-500/5 rounded-full blur-2xl"></div>
        ...
        <div className="space-y-2">
          ...
          <input
            type="text"
            required
            className="w-full bg-slate-900 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/20 focus:border-red-500/50 focus:ring-1 focus:ring-red-500/50 outline-none transition-all"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input
              type="text"
              className="w-full bg-slate-900 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/20 focus:border-red-500/30 outline-none transition-all"
        ...
        <div className="space-y-2">
          ...
          <select
            className="w-full bg-slate-900 border border-white/10 rounded-lg px-4 py-3 text-white focus:border-red-500/50 focus:ring-1 focus:ring-red-500/50 outline-none transition-all appearance-none cursor-pointer"
            value={selectedRepo}
          ...
          {reposLoading && <p className="text-[10px] text-red-500 animate-pulse">Loading your repositories...</p>}
        ...
        <div className="flex items-center space-x-3 bg-red-500/5 p-4 rounded-lg border border-red-500/20 mb-2">
          <input 
            type="checkbox" 
            id="isMock"
            className="w-5 h-5 rounded border-red-500/30 bg-slate-900 text-red-500 focus:ring-red-500/50 cursor-pointer"
            checked={isMock}
            onChange={(e) => setIsMock(e.target.checked)}
          />
          <label htmlFor="isMock" className="text-sm text-white/80 cursor-pointer select-none">
            <span className="font-bold text-red-500">Enable Demo Mode:</span> Launch a specialized product showcase with pre-defined high-quality results.
          </label>
        </div>
        ...
        <div className="bg-white/5 border border-white/5 rounded-lg p-4">
          <p className="text-xs text-white/40 leading-relaxed">
            <span className="text-red-500 font-bold">Note:</span> Gemini 1.5 Pro will explore the website, 
